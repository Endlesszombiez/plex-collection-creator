...
export function CustomPromptCard({ scanId, movieCount, showCount }: CustomPromptCardProps) {
      ...
      <div className="p-6">
        ...
        {status === "idle" && (
          <div className="mb-6 space-y-4">
            <div>
              <label htmlFor="custom-prompt" className="block text-sm font-medium text-white/70 mb-2">
              ...
              <textarea
                ...
                className="w-full h-24 px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white placeholder:text-white/30 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-colors"
              />
            </div>
            ...
            <p className="text-xs text-white/30">
              AI will search through {totalItems} items ({movieCount} movies, {showCount} shows)
            </p>
          </div>
        )}
